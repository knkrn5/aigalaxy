    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="relative">
          <div className="w-96 h-96 border border-blue-500/10 rounded-full animate-spin" style={{ animationDuration: '20s' }}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 border border-purple-500/10 rounded-full animate-spin" style={{ animationDuration: '15s', animationDirection: 'reverse' }}></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 border border-cyan-500/10 rounded-full animate-spin" style={{ animationDuration: '10s' }}></div>
        </div>
      </div>

      {/* Main content */}
      <div className={`relative z-10 text-center max-w-4xl mx-auto transition-all duration-1000 ${animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        {/* 404 Number with cosmic effect */}
        <div className="relative mb-8">
          <div className={`text-9xl md:text-[12rem] font-black mb-4 transition-all duration-1000 delay-300 ${animateIn ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
        ...
        {/* Lost in space icon */}
        <div className={`mb-8 transition-all duration-1000 delay-500 ${animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
        ...
        {/* Main heading */}
        <h1 className={`text-4xl md:text-6xl font-bold mb-6 transition-all duration-1000 delay-700 ${animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <span className="bg-gradient-to-r from-blue-400 via-purple-500 to-cyan-400 bg-clip-text text-transparent">
            Lost in the Galaxy
          </span>
        </h1>
        ...
        {/* Subtitle */}
        <h2 className={`text-xl md:text-2xl text-gray-300 mb-8 transition-all duration-1000 delay-900 ${animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          The page you're looking for has drifted into deep space
        </h2>

        {/* Description */}
        <div className={`space-y-4 mb-12 transition-all duration-1000 delay-1100 ${animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <p className="text-gray-400 text-lg leading-relaxed max-w-2xl mx-auto">
            It seems like you've ventured into uncharted territory. The page you're seeking might have been 
            moved, deleted, or perhaps it never existed in this dimension of our galaxy.
          </p>
        ...
        {/* Search box */}
        <div className={`mb-12 transition-all duration-1000 delay-1300 ${animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="max-w-md mx-auto">
            <label className="block text-gray-400 text-sm mb-2">Search the Galaxy</label>
            <div className="relative">
              <input
                type="text"
                value={searchTerm}
        ...
        {/* Action buttons */}
        <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center transition-all duration-1000 delay-1500 ${animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <NavLink
            to="/"
        ...
        {/* Fun fact */}
        <div className={`mt-16 text-center transition-all duration-1000 delay-1700 ${animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
          <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-4 backdrop-blur-sm inline-block">
            <p className="text-purple-400 text-sm">
              🌌 <strong>Fun Fact:</strong> There are an estimated 2 trillion galaxies in the observable universe, 
